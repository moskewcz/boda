...
class figgen_t( object ):
    def __init__( self, args ):
        ...
        fmt_data = { "wis" : "--wisdom-in-fn=" + args.wis_fn, 
                     ...
                     "s_img" : "--s-img=5" }
        # generate ocl/nvrtc comparison figure: titan-ocl-vs-nvrtc.pdf
        cmds = [
        ...
        # generate AMD tuning figure: fiji-tune.pdf
        cmds = [
        ...
        run_cmds( cmds, fmt_data )
        # generate NVIDIA tuning figure: titan-tune.pdf
        cmds = [
        ...
        run_cmds( cmds, fmt_data )
        # generate all-plats figure: all-plats.pdf
        cmds = [
